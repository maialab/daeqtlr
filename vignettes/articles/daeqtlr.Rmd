...
test when performing DAEQTL mapping.
...
- Zygosity: degree to which both copies of a loci have the same genetic
sequence. If both copies are the same, then the loci are homozygous, if they are
different, the loci are heterozygous.
